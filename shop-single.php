        ...
        <section class="page-banner bg-image pt-130 pb-130" data-background="assets/images/banner/inner-banner.jpg">
            <div class="container">
                ...
                <div class="breadcrumb-list wow fadeInUp" data-wow-duration="1.3s" data-wow-delay=".3s">
                    ...
                    <h3>Shop# Abbas Silk  <br>
                 Address# Shop 13 Banarus Colony khairpur Mirs
                         </h3>
                </div>
            </div>
        </section>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO user_reviews (name, email, review, time) VALUES ('$name', '$email', '$review', NOW())";
...
<div class="container">
    ...
    // Example query (make sure to replace with your actual query)
    $query = "SELECT name, review, time FROM user_reviews"; // Adjust this as needed
    ...
    if ($result === false) {
        ...
        // Initialize $result to prevent undefined variable warnings
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                $formattedTime = date("d F Y \a\t h:i a", strtotime($time));

                // Generate HTML for each review
                echo '<div class="abmin d-flex flex-wrap flex-md-nowrap align-items-center pb-4">';

                echo '    <div class="content position-relative p-4 bor">';
                echo '        <div class="head-wrp pb-1 d-flex flex-wrap justify-content-between">';
                echo '            <a href="#0">';
                echo '                <h4 class="text-capitalize primary-color">' . $name . '<span class="sm-font ms-2 fw-normal">' . $formattedTime . '</span></h4>';
                echo '            </a>';
                echo '            <div class="star primary-color">';
                echo '                <span><i class="fa-solid fa-star sm-font"></i></span>';
                echo '                <span><i class="fa-solid fa-star sm-font"></i></span>';
                echo '                <span><i class="fa-solid fa-star sm-font"></i></span>';
                echo '                <span><i class="fa-solid fa-star sm-font"></i></span>';
                echo '                <span><i class="fa-solid fa-star-half-stroke sm-font"></i></span>';
                echo '            </div>';
                echo '        </div>';
                echo '        <p class="text-justify">' . $review . '</p>';
                echo '    </div>';
                echo '</div>';
            }
        } else {
    ...
    ?>
                                    ...
                                    <form action="#" method="POST">
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                <input type="text" name="name" class="w-100 mb-4 bor px-4 py-2"
                                                    placeholder="Your Name*">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="email" name="email"class="w-100 mb-4 bor px-4 py-2"
                                                    placeholder="Your Email*">
                                            </div>
                                        </div>
                                        <textarea class="w-100 mb-4 bor p-4" name="review" placeholder="Message"></textarea>
                                    
                                    <div class="btn-wrp">
                                        <button class="btn-one" type="submit" value="submit"><span>Submit Now</span></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
