                ...
                <div class="row g-4">
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".1s">
                        <div class="footer__item">
                            ...
                            <ul>
                                <li><a href="contact.php"><span></span>Help Portal</a></li>
                                <li><a href="contact.php"><span></span>Contact Us</a></li>
                                <li><a href="error.php"><span></span>Delivery Information</a></li>
                                <li><a href="error.php"><span></span>Click and Collect</a></li>
                                <li><a href="error.php"><span></span>Refunds and Returns</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">
                        <div class="footer__item">
                            ...
                            <ul>
                                ...
                                <li><a href="blog-grid.php"><span></span>News & Blog</a></li>
                                <li><a href="error.php"><span></span>Careers</a></li>
                                <li><a href="error.php"><span></span>Investors</a></li>
                                <li><a href="contact.php"><span></span>Contact Us</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.3s" data-wow-delay=".3s">
                        <div class="footer__item">
                            ...
                            <ul>
                                <li><a href="shop.php"><span></span>E-Cigarettes</a></li>
                                <li><a href="shop.php"><span></span>Vape Pens</a></li>
                                <li><a href="shop.php"><span></span>Pod Systems</a></li>
                                <li><a href="shop.php"><span></span>Disposable Vapes</a></li>
                                <li><a href="shop.php"><span></span>Nicotine Salt Devices</a></li>
                            </ul>
                        </div>
                    </div>
